const CACHE_NAME = 'overtime-pwa-cache-v8.0.0'; // Final Stable Architecture
const urlsToCache = [
  './',
  './index.html',
  './manifest.json'
...
self.addEventListener('fetch', event => {
  // Only handle requests for our own app (local origin).
    ...
    event.respondWith(
      caches.match(event.request)
        .then(cachedResponse => {
          ...
          // We don't cache it here because external resources are not managed by this SW.
